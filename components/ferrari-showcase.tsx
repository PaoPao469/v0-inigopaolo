...
interface FerrariShowcaseProps {
  ...
  return (
    <div className="min-h-screen px-6 py-24 md:px-12 lg:px-24">
      ...
      <header className="mb-8">
        ...
        >
          A stunning showcase of the Ferrari 488 Pista - capturing the essence of Italian engineering and design excellence through professional automotive photography.
        </p>
      </header>
