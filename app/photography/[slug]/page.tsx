...
import { getProjectBySlug, getProjectImages, getAdjacentProjects, photographyProjects } from "@/lib/projects"
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const project = getProjectBySlug("photography", slug)
  ...
  return {
    title: `${project.title} | Photography | Inigo Paolo`,
    description: project.description,
  }
}

export default async function PhotographyProjectPage({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params
  const project = getProjectBySlug("photography", slug)
  ...
  const { prev, next } = getAdjacentProjects("photography", slug)
